        ...
        return (
            <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                <div style={{ marginBottom: '24px' }}>
                    ...
                    <p style={{ color: '#64748b', margin: '4px 0 0 0' }}>Comprehensive view of all detected connections</p>
                </div>
                ...
                <div style={{ background: '#ffffff', borderRadius: '24px', flex: 1, boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.02)', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                    <div style={{ overflowX: 'auto', flex: 1, padding: '0' }}>
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            <thead style={{ background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
                                <tr>
                                    <th style={{ padding: '20px 24px', textAlign: 'left', fontSize: '12px', fontWeight: '600', color: '#64748b', textTransform: 'uppercase' }}>Subject A</th>
                                    <th style={{ padding: '20px 24px', textAlign: 'left', fontSize: '12px', fontWeight: '600', color: '#64748b', textTransform: 'uppercase' }}>Connection Type</th>
                                    <th style={{ padding: '20px 24px', textAlign: 'left', fontSize: '12px', fontWeight: '600', color: '#64748b', textTransform: 'uppercase' }}>Subject B</th>
                                    <th style={{ padding: '20px 24px', textAlign: 'left', fontSize: '12px', fontWeight: '600', color: '#64748b', textTransform: 'uppercase' }}>Suspicious Link Data</th>
                                </tr>
                            </thead>
                            <tbody>
                                {loading ? (
                                    <tr><td colSpan="4" style={{ padding: '40px', textAlign: 'center', color: '#64748b' }}>Loading intelligence data...</td></tr>
                                ) : linkages.length === 0 ? (
                                    <tr><td colSpan="4" style={{ padding: '40px', textAlign: 'center', color: '#64748b' }}>No linkages detected yet.</td></tr>
                                ) : (
                                    linkages.map((link, idx) => (
                                        <tr key={idx} style={{ borderBottom: '1px solid #f1f5f9' }}>
                                            <td style={{ padding: '20px 24px' }}>
                                                <div style={{ fontWeight: '600', color: '#1e293b' }}>{link.profile1?.name || 'Unknown'}</div>
                                                <div style={{ fontSize: '12px', color: '#94a3b8' }}>ID: {link.profile1?.profileId || 'N/A'}</div>
                                            </td>
                                            <td style={{ padding: '20px 24px' }}>
                                                <span style={{ 
                                            ...
                                            <td style={{ padding: '20px 24px' }}>
                                                <div style={{ fontWeight: '600', color: '#1e293b' }}>{link.profile2?.name || 'Unknown'}</div>
                                                <div style={{ fontSize: '12px', color: '#94a3b8' }}>ID: {link.profile2?.profileId || 'N/A'}</div>
                                            </td>
                                            <td style={{ padding: '20px 24px' }}>
                                                <div style={{ fontSize: '13px', color: '#475569' }}>
                                                    {link.matchedFields?.map((m, i) => (
                                                        <div key={i} style={{ marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                                            ...
                                                            <span style={{ 
                                                                background: '#fee2e2', color: '#991b1b', padding: '4px 8px', borderRadius: '4px',
                                                                fontFamily: 'monospace', fontWeight: '600', fontSize: '12px', border: '1px solid #fca5a5'
                                                            }}>
                                                                {m.value1}
                                                            </span>
                                                        </div>
