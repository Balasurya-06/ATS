...
function Dashboard() {
  ...
  const [isDashboardProfilesLoading, setIsDashboardProfilesLoading] =
    useState(true);
        ...
        <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
          ...
          >
            ...
            >
              ...
              >
                {isProfilesLoading ? "⏳" : "🔄"}{" "}
                {isProfilesLoading ? "Refreshing..." : "Refresh"}
              </button>
            </div>
          </div>
                      ...
                      >
                        ...
                        <td style={{ padding: "12px", fontSize: "14px" }}>
                          <span
                            style={{
                              ...
                              fontWeight: "500",
                              backgroundColor:
                                profile.radicalizationLevel === "High"
                                  ? "#fecaca"
                                  : profile.radicalizationLevel === "Medium"
                                    ? "#fef3c7"
                                    : "#d1fae5",
                              color:
                                profile.radicalizationLevel === "High"
                        ...
                        <td style={{ padding: "12px", fontSize: "14px" }}>
                          <span
                            style={{
                              ...
                              fontWeight: "500",
                              backgroundColor:
                                profile.fileClassification === "Top Secret"
                                  ? "#7f1d1d"
                                  : profile.fileClassification === "Secret"
                                    ? "#dc2626"
                                    : "#6b7280",
                              color: "#ffffff",
                            }}
                        ...
                        <td style={{ padding: "12px", textAlign: "center" }}>
                          ...
                          >
                            ...
                            <button
                              onClick={() =>
                                handleDeleteProfile(profile._id, profile.name)
                              }
                              disabled={isLoading}
                              style={{
            ...
            >
              ...
              <div style={{ padding: "32px" }}>
                ...
                <div style={{ marginBottom: "24px" }}>
                  ...
                  <input
                    ...
                    onKeyPress={(e) =>
                      e.key === "Enter" && confirmDeleteProfile()
                    }
              ...
              >
                ...
                <button
                  ...
                  style={{
                    background:
                      pin.length >= 4 && !isLoading ? "#dc2626" : "#9ca3af",
                    color: "#ffffff",
                    border: "none",
                    borderRadius: "8px",
                    padding: "10px 24px",
                    ...
                    fontWeight: "500",
                    cursor:
                      pin.length >= 4 && !isLoading ? "pointer" : "not-allowed",
                    display: "flex",
                    alignItems: "center",
                    gap: "8px",
                  }}
  ...
  return (
    ...
    >
      ...
      >
        <span>
          <strong>System Notice:</strong> Daily backup scheduled for 03:00 hrs.
          New threat assessment module available.
        </span>
      </div>
      ...
      >
        ...
        >
          ...
          <div>Last system update: January 2025 | Server status: Online</div>
        </div>
      </div>
    </div>
  );
